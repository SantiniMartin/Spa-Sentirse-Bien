          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-emerald-900 sm:text-5xl md:text-6xl">
                <span className="block xl:inline">Tu bienestar</span>{' '}
                <span className="block text-emerald-600 xl:inline">Nuestra prioridad</span>
              </h1>
              <p className="mt-3 text-base text-gray-600 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
              Experimente la tranquilidad en el sereno ambiente de nuestro spa. Nuestros terapeutas expertos ofrecen tratamientos rejuvenecedores diseñados para restaurar el equilibrio de cuerpo y mente.
              </p>
